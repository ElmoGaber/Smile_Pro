...
export const listServices = async (
  ...
  return customFetch<DentalService[]>(getListServicesUrl(), {
    ...options,
    method: "GET",
  });
};
...
>(options?: {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getClinicStats>>> = ({
    signal,
  }) => getClinicStats({ signal, ...requestOptions });
 ...
 */
export const getListUpcomingAppointmentsUrl = () => {
...
export const listUpcomingAppointments = async (
  ...
  return customFetch<Appointment[]>(getListUpcomingAppointmentsUrl(), {
    ...options,
    method: "GET",
  });
};

export const getListUpcomingAppointmentsQueryKey = () => {
  return [`/api/appointments/upcoming`] as const;
};

export const getListUpcomingAppointmentsQueryOptions = <
  TData = Awaited<ReturnType<typeof listUpcomingAppointments>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
  ...
  const queryKey =
    queryOptions?.queryKey ?? getListUpcomingAppointmentsQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listUpcomingAppointments>>
  > = ({ signal }) => listUpcomingAppointments({ signal, ...requestOptions });
...
export type ListUpcomingAppointmentsQueryResult = NonNullable<
  Awaited<ReturnType<typeof listUpcomingAppointments>>
>;
...
export function useListUpcomingAppointments<
  TData = Awaited<ReturnType<typeof listUpcomingAppointments>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
  ...
  const queryOptions = getListUpcomingAppointmentsQueryOptions(options);
